...
/** Strongly typed access to the database table "staff".
 *
...
public class StaffTable
{
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockStaffTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( StaffTable.Implementation instance  )
    {
        imp = instance ;
    }
