...
/** Strongly typed access to the database table "Feedback".
 *
...
public class FeedbackTable
{
    ...
    public static final String feedbackColumnName = "Feedback";

    private static String[] allColumns =
    {
        firstNameColumnName , lastNameColumnName , ageColumnName , emailColumnName , feedbackColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockFeedbackTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( FeedbackTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.ageNull = ( data[2] == null );
                this.age = ageNull ? 0 : Str.toInt( data[2] );
                this.email = data[3];
                this.feedback = data[4];
        ...
        public void setAgeNull( boolean ageNull )
        {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( firstNameColumnName , this.firstName );
            data.put( lastNameColumnName , this.lastName );
            data.put( ageColumnName , this.ageNull ? null : String.valueOf( this.age ) );
            data.put( emailColumnName , this.email );
            data.put( feedbackColumnName , this.feedback );
            return data ;
        }
