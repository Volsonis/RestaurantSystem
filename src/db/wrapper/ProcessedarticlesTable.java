...
/** Strongly typed access to the database table "Processedarticles".
 *
 ...
 *
 */
public class ProcessedarticlesTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "Processedarticles";
    ...
    {
        processedorders_idColumnName , dish_idColumnName , processedarticles_idColumnName , quantityColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockProcessedarticlesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( ProcessedarticlesTable.Implementation instance  )
    {
        imp = instance ;
    }
