...
/** Strongly typed access to the database table "Discount".
 *
...
public class DiscountTable
{
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockDiscountTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( DiscountTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private String type ;
        private int amount ;
        private boolean amountNull = true ;
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.amount = amountNull ? 0 : Str.toInt( data[3] );
