...
/** Strongly typed access to the database table "Tables".
 *
...
public class TablesTable
{
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockTablesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( TablesTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                this.table_id =  Str.toInt( data[0] );
        ...
        private Map buildDataMap()
        {
            ...
            data.put( table_idColumnName , String.valueOf(  this.table_id ) );
