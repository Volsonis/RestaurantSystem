...
/** Strongly typed access to the database table "menu".
 *
...
public class MenuTable
{
    ...
    {
        dish_idColumnName , typeColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockMenuTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( MenuTable.Implementation instance  )
    {
        imp = instance ;
    }
