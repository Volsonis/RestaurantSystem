...
public class IngredientChooser extends JDialog
{
  ...
  public static void main(String[] args)
  {
    try
    {
      IngredientChooser dialog = new IngredientChooser();
  ...
  public IngredientChooser(Component parent, final Dish dish) {
    ...
    contentPanel.setLayout(new BorderLayout(0, 0));
    {
      ...
      contentPanel.add(scrollPane, BorderLayout.CENTER);
      {
        ...
        panel.setMaximumSize(new Dimension(250, 32767));
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            for(int i=0; i<checkboxes.length; i++)
            {
              if(checkboxes[i].isSelected())
              {
                ...
                //find that ingredient in the ingredient arraylist and add it to the chosenIngredients
