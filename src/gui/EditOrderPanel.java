...
public class EditOrderPanel extends JPanel
{
   ...
   * @throws SQLException 
   */
  public EditOrderPanel(final Component parent, final main.Order order, final OrdersFrame parentFrame) throws SQLException {
    ...
    totalLabel = new JLabel(String.valueOf(order.getPrice()));
    totalLabel.setBorder(new LineBorder(new Color(0, 0, 0)));
    
    JSeparator separator = new JSeparator();
    
    final JLabel lblNewLabel_3 = new JLabel("Edit Order: " + order.getPendingorders_id());
    ...
    btnStarters.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/food-fried_egg_sunny.png")));
    ...
    btnMains.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/draw-circle-2.png")));
    ...
    btnSides.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/draw-halfcircle1.png")));
    ...
    btnDeserts.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/food-cupcake_iced_with_cherry.png")));
    ...
    btnSoftDrinks.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/water_drop_1.png")));
    ...
    btnDrinks.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/food-beer.png")));
    ...
    btnAll.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/draw-donut.png")));
    toolBar.add(btnAll);
    ...
    btnRemove.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/archive-remove.png")));
    ...
    btnCancel.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/dialog-cancel-2.png")));
    ...
    btnPay.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/kwallet.png")));
    toolBar_1.add(btnPay);
    
    JButton btnDiscount = new JButton("Discount");
    btnDiscount.setEnabled(false);
    btnDiscount.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/emblem-advertisement-pound.png")));
    toolBar_1.add(btnDiscount);
    
    JButton btnCustomer = new JButton("Customer");
    btnCustomer.setEnabled(false);
    btnCustomer.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/identity.png")));
    ...
    btnNote.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/view-pim-notes.png")));
    ...
    btnTable.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/draw-square-inverted-corners.png")));
    ...
    btnSubmit.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        ...
        try
        {
          //edit the dish ids to the order
          ...
          //submit order
          DBInterface.editOrder(order.getPendingorders_id(), order);
          
          //TODO then reset to a new order window
          //for now just show whether successful
          lblNewLabel_3.setText("Success!");  
        } catch (SQLException e)
        {
    ...
    btnSubmit.setIcon(new ImageIcon(EditOrderPanel.class.getResource("/gui/resources/img32x32/document-import.png")));
    ...
    for(int i=0; i<arows.length; i++)
    {
      ...
      {
        if(arows[i].getDish_id() == allDishes.get(j).getID())
        {
          model.addRow(new String[]{allDishes.get(j).getName(),String.valueOf(allDishes.get(j).getPrice())});
          dishesOrdered.add(allDishes.get(j));
        }
      }
    }
