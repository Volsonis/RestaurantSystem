...
public class NotesEditor extends JDialog
{
  ...
  */
   ...
   * Create the dialog.
   */
  public NotesEditor(Component parent, final main.Order order){
    ...
    setIconImage(Toolkit.getDefaultToolkit().getImage(NotesEditor.class.getResource("/gui/resources/img16x16/view-pim-notes.png")));
      ...
      getContentPane().add(buttonPane, BorderLayout.SOUTH);
      {
        ...
        okButton.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            try
            {
              DBInterface.editOrderNote(order);
            } catch (SQLException e1)
            {
              Error err = new Error(parentFrame,"Database Error", e1.getMessage());
              err.setVisible(true);
